...
const CHAIN_ID       = 'rebel-2'; // TESTNET
const LUNC_PER_TICKET = 100; // TESTNET — 100 LUNC per ticket

// ── Free entries from Terra Oracle (GitHub JSON) ─────────────────────────────
const FREE_ENTRIES_URL = 'https://raw.githubusercontent.com/Baydashaaa/oracle-draw/main/free-entries.json'; // shared with mainnet
...
const MIN_TICKETS    = 2; // TESTNET — minimum 2
const LCD_NODES      = [
  'https://lcd.luncblaze.com', // TESTNET rebel-2
];
const RPC_NODES      = [
...
async function buyTicketsKeplr() {
  ...
  try {
    ...
    const signDoc = {
      ...
      sequence,
      fee: { amount: [{ denom: 'uluna', amount: '2500000' }], gas: '200000' },
      msgs: [{
    ...
    const feeAmountBytes = enc.encode('2500000');
